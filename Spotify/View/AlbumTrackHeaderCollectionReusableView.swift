//
//  AlbumTrackHeaderCollectionReusableCell.swift
//  Spotify
//
//  Created by user212878 on 8/4/22.
//

import Foundation
import UIKit
protocol AlbumHeaderCollectionReusableViewDelegate {
    func AlbumHeaderCollectionReusableViewDidTapPlatAll(_ header: AlbumTrackHeaderCollectionReusableView)
}
class AlbumTrackHeaderCollectionReusableView: UICollectionReusableView {
    static let identifier = "AlbumTrackHeaderCollectionReusableView"
    var delegate: AlbumHeaderCollectionReusableViewDelegate?
    ...
    @objc func didTapPlayAllBtn(){
       // delegate?.PlayListHeaderCollectionReusableViewDidTapPlatAll(self)
        delegate?.AlbumHeaderCollectionReusableViewDidTapPlatAll(self)
    }
